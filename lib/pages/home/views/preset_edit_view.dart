          ...
          children: [
            if (groupName != null) ...[
              ...
              FlyoutTarget(
                ...
                child: IconButton(
                  icon: const PhosphorIcon(PhosphorIconsBold.dotsThreeVertical,
                      size: 16),
    ...
    _getMenuController(groupName).showFlyout(
      ...
      builder: (context) => MenuFlyout(
        items: [
          ...
          MenuFlyoutItem(
            leading:
                PhosphorIcon(PhosphorIconsRegular.trash, color: Colors.red),
  ...
  List<ComboBoxItem<String?>> _buildComboBoxItems(AppLocalizations loc) {
    return [
      ...
      ComboBoxItem<String?>(
        ...
        child: Row(
          children: [
            const PhosphorIcon(PhosphorIconsRegular.pencilSimple, size: 16),
            const SizedBox(width: 8),
      ...
      if (store.selectedGameConfigId != null)
        ComboBoxItem<String?>(
          ...
          child: Row(
            children: [
              const PhosphorIcon(PhosphorIconsRegular.x, size: 16),
              const SizedBox(width: 8),
